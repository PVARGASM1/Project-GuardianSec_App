  ...
  return (
    ...
    <nav className="mx-auto flex max-w-7xl items-center justify-between p-2 base:px-2" aria-label="Global">
      ...
      <Popover.Group className="hidden lg:flex lg:gap-x-4">
        ...
        <div href={'/consulting'} className="text-xl font-semibold leading text-white-900">
          Agendar consultoria
        </div>

        <div href={'/register'} className="text-xl font-semibold leading text-white-900">
          Registrate ahora
        </div>
      </Popover.Group>
      <div className="hidden lg:flex lg:flex-1 lg:justify-end">
        <div href={'/login'} className="text-xl font-semibold leading text-white-900">
    ...
    <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
      ...
      <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-4 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
        <div className="flex items-center justify-between">
          <div href={'/home'} className="-m-1.5 p-1.5">
